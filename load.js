...
/**
 * Tenant to write to on the write path.
 * @constant {string}
 */
 ...
 * @constant {string}
 */
const WRITE_HOSTNAME = __ENV.WRITE_HOSTNAME
/**
 * Hostname to connect to on the read path.
 * @constant {string}
 */
const READ_HOSTNAME = __ENV.READ_HOSTNAME
/**
 ...
 * @constant {number}
 */
const WRITE_SERIES_PER_REQUEST = parseInt(__ENV.WRITE_SERIES_PER_REQUEST || 1000);
/**
 ...
 * @constant {number}
 */
const READ_REQUEST_RATE = parseInt(__ENV.READ_REQUEST_RATE ||  1);
/**
 ...
 * @constant {number}
 */
const SCRAPE_INTERVAL_SECONDS = parseInt(__ENV.SCRAPE_INTERVAL_SECONDS || 20);
/**
